...
# Single-node BERT Chimera 2-VR Asymmetric Pipeline Parallelism (4 GPUs)
...
# NOTE: num-layers=24 config — create this if it doesn't exist yet
CHIMERA_ASYM_CONFIG=asymmetric_bitpipe/configs/chimera/4_devices/chimera_4devices_24layers.json

mkdir -p $CHECKPOINT_PATH

WORLD_SIZE=$((GPUS_PER_NODE * NNODES))

echo "Running Single-node BERT Chimera 2-VR Asymmetric Pipeline Parallelism..."
echo "=================================="
echo "Total GPUs: $WORLD_SIZE ($NNODES node x $GPUS_PER_NODE GPUs/node)"
echo "Pipeline stages: $GPUS_PER_NODE"
echo "Node rank: $NODE_RANK"
echo "Master addr: $MASTER_ADDR"
echo "Schedule: Chimera 2-VR Asymmetric"
echo "Config: $CHIMERA_ASYM_CONFIG"
echo "=================================="
